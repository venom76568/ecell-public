    ...
    return (
        <>
            ...
            <div className="bg-[#0C0C0C] pt-10 pb-36">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-evenly items-center pt-20 gap-10">
                    <div className="md:col-span-2 lg:col-span-3 justify-center items-center flex flex-col gap-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            <div className="bg-gradient-to-b p-[3px] from-[rgba(8,107,234,1)] to-[rgba(2,152,249,0)]">
                                <div className="flex flex-col h-full gap-6 bg-black">
                                    <Image
                                        src={bhatt_sir}
                                        alt="Bhatt Sir"
                                        className="self-center p-1 w-96 h-96"
                                    />
                                    <div className="flex flex-col justify-center gap-2 mt-5">
                                        <span className="font-bold text-2xl text-center text-transparent bg-clip-text bg-gradient-to-b from-[#0298F9] to-[#086BEA]">Dr. S. S. Bhatt</span>
                                        <span className="font-bold text-lg text-center text-white">Advisor</span>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-gradient-to-b p-[3px] from-[rgba(8,107,234,1)] to-[rgba(2,152,249,0)]">
                                <div className="flex flex-col h-full gap-6 bg-black">
                                    ...
                                    />
                                    <div className="flex flex-col justify-center gap-2 mt-5">
                                        <span className="font-bold text-2xl text-center text-transparent bg-clip-text bg-gradient-to-b from-[#0298F9] to-[#086BEA]">Dr. R. V. Taiwade</span>
                                        <span className="font-bold text-lg text-center text-white">Professor Incharge</span>
                                    </div>
                                </div>
                            </div>
                            <div className="bg-gradient-to-b p-[3px] from-[rgba(8,107,234,1)] to-[rgba(2,152,249,0)]">
                                <div className="flex flex-col h-full gap-6 bg-black">
                                    ...
                                    />
                                    <div className="flex flex-col justify-center gap-2 mt-5">
                                        <span className="font-bold text-2xl text-center text-transparent bg-clip-text bg-gradient-to-b from-[#0298F9] to-[#086BEA]">Dr. Karthik Balasundaram</span>
                                        <span className="font-bold text-lg text-center text-white">Professor Incharge</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-evenly items-center pt-36 gap-10">
                    <div className="md:col-span-2 lg:col-span-3 justify-center items-center flex flex-col gap-10">
                        <div className="flex flex-col gap-3 items-center justify-center text-5xl font-semibold">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            <div>
                                <div className="bg-gradient-to-b p-[3px] from-[rgba(8,107,234,1)] to-[rgba(2,152,249,0)]">
                                    <div className="flex flex-col h-full gap-6 bg-gradient-to-b from-[rgba(8,107,234,0)] to-[rgba(2,152,249,0.5)]">
                                        <Image
                                            src={bhargav}
                                            alt="Bhargav"
                                            className="self-center p-1 w-96 h-96"
