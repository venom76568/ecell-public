...
const Initiatives = () => {
  return (
    <div id="initiatives" className="max-h-full mt-20 bg-black bg-[url('/assets/back.png')] bg-no-repeat bg-center bg-cover bg-blend-luminosity">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-center lg:justify-evenly pt-20 gap-20 space-x-5">
          <div className="flex flex-col items-center lg:items-end">
            ...
            <div className="h-full w-3/4 lg:w-1/2 bg-[#161616] mt-8 p-8 flex flex-col justify-end">
              ...
              <Link href="https://csuites.ecellvnit.org/" target="_blank" className="w-full bg-gradient-to-b from-[#0298F9] to-[#086BEA] uppercase text-center text-lg sm:w-1/2 self-center py-4 mt-10 scale-75 text-white">Know More</Link>
            </div>
          </div>
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="h-full w-3/4 lg:w-1/2 bg-[#161616] mt-8 p-8 flex flex-col justify-center">
              ...
              <Link href="https://neo.ecellvnit.org/" target="_blank" className="w-full bg-gradient-to-b from-[#0298F9] to-[#086BEA] uppercase text-center text-lg sm:w-1/2 self-center py-4 mt-10 scale-75 text-white">Know More</Link>
            </div>
          </div>
          <div></div>
        </div>
