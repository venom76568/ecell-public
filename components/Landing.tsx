...
const Landing = () => {
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className="absolute inset-0 min-h-screen max-w-full bg-[#1C1C1C] bg-[url('/assets/BackgroundImage1.png')] bg-blend-luminosity bg-no-repeat bg-center bg-cover ">
