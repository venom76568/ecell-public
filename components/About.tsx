...
const About = () => {
    return (
        <div id="about" className="h-full bg-[#0C0C0C] bg-[url('/assets/back2.png')] bg-cover bg-no-repeat bg-blend-luminosity">
            <div className="h-5/6 lg:h-screen w-full bg-gradient-to-b from-[rgba(0,0,0,1)] to-[rgba(12,12,12,0.8)] grid grid-cols-1 content-center bg-opacity-80">
                <div className="px-10">
                    <div className="w-full grid grid-cols-1 lg:grid-cols-2 bg-[#1B1B1B] shadow-[0_8px_40px_2px_rgba(255,255,255,0.08)]">
                        ...
                        <div className="flex flex-col px-10 py-14 gap-14 justify-center">
                            <div className="uppercase text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl text-transparent bg-clip-text bg-gradient-to-b from-[#0298F9] to-[#086BEA] font-bold">ABOUT E-CELL VNIT</div>
